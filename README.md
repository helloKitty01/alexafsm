...
| [docs/llm-choice/](./docs/llm-choice/) | 2026-09-23 模型与 agent 怎么选：API 价、订阅、Artificial Analysis 效果与速度、易用。默认建议是自建用 GPT-6 Sol，难回合升 Opus 5.5，人写代码用 Claude Pro，不把生活代办交给 Muse 外呼。另有收费展开：输入与输出分开计价的原因，以及 Cursor Ultra $200 里 Fable 5.1 的 token 折算 |
