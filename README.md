...
| [docs/phone-assistant-automation/](./docs/phone-assistant-automation/) | 手机智慧助手需求与方案（统一任务模型：定时/事件/自定义监视/长时异步任务，双脑架构 + 打扰管理器；含多任务管理 Agent v1.2 幻灯片：消息·响应·任务三层 × 事件驱动 loop × 双层上下文，v1.0/v1.1 留档 history/） |
