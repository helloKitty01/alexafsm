...
| [docs/llm-choice/](./docs/llm-choice/) | 2026-09-23 模型与 agent 怎么选：API 价、订阅、Artificial Analysis 效果与速度、易用。默认建议是自建用 GPT-6 Sol，难回合升 Opus 5.5，人写代码用 Claude Pro，不把生活代办交给 Muse 外呼 |
