...
沉淀仓库内 HTML 幻灯片的**画图、动态、交付**规范。起点是对 [tt-a1i/archify](https://github.com/tt-a1i/archify) skill 的分析,落地样板是 `docs/kv-cache-discussion/kv cache方案(汇报版·升级版).v2.slides.html`(5 张 archify 图,全部可分章、可 trace)。
...
8. 版式:architecture / workflow / sequence 可"左图右卡";dataflow 必须整页横贯,否则字号不可读。
