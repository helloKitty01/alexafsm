...
| [KV-Cache收益闭环.v2.slides.html](./KV-Cache收益闭环.v2.slides.html) | 汇报幻灯片 v2(内部预估参数:静态20K/用户3K/query相关8K/UAT 5K·轮/每轮2次请求):P1 上下文结构条+一轮query解剖+断裂点,P2 逐轮(1~5轮)账目双条图,逐轮标注节省(-37%→-79%),会话118K→38K(-68%),模型11.8K与现网实测12K互验 |
